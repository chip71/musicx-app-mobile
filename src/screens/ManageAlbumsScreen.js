  ...
  return (
    <SafeAreaView style={styles.safeContainer}>
      <View style={styles.container}>
        ...
        {loading ? (
          ...
          <ScrollView contentContainerStyle={{ paddingBottom: 100 }}>
            {filteredAlbums.map((item) => (
              <View key={item._id} style={styles.albumCard}>
                <Image
                ...
                <View style={{ flex: 1, marginLeft: 10 }}>
                  ...
                  <Text style={styles.albumPrice}>{item.format} • {item.price?.toLocaleString()}₫</Text>
                </View>
        ...
        <Modal isVisible={modalVisible} onBackdropPress={() => setModalVisible(false)} avoidKeyboard>
          <KeyboardAvoidingView behavior={Platform.OS === "ios" ? "padding" : "height"} style={{ flex: 1 }}>
            <View style={styles.modalContent}>
              <ScrollView keyboardShouldPersistTaps="handled">
                <Text style={styles.modalTitle}>{editingAlbum ? "Edit Album" : "Add Album"}</Text>
                ...
                <View style={{ flexDirection: "row", justifyContent: "space-between", marginBottom: 10 }}>
                  <View style={{ flex: 1, marginRight: 5 }}>
                    <DropDownPicker
                      ...
                      zIndexInverse={1000}
                      portal
                      portalProps={{ container: Platform.OS === "web" ? document.body : null }}
                    />
                ...
                {form.image ? (
                  ...
                  <Text style={{ textAlign: "center", color: "#666", marginBottom: 10 }}>No image preview</Text>
                )}

                <View style={styles.modalActions}>
                  <TouchableOpacity style={[styles.modalBtn, { backgroundColor: "#222" }]} onPress={handleSave}>
...
const styles = StyleSheet.create({
  ...
  albumCard: { flexDirection: "row", backgroundColor: "#f7f7f7", padding: 12, borderRadius: 10, marginBottom: 10, alignItems: "center" },
  ...
  addButton: { position: "absolute", bottom: 25, right: 25, backgroundColor: "#000", width: 56, height: 56, borderRadius: 30, alignItems: "center", justifyContent: "center" },
  modalContent: { backgroundColor: "#fff", borderRadius: 12, padding: 16, maxHeight: "90%", marginTop : "50"},
